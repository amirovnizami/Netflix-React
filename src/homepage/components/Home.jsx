            ...
            {trendingMovies?.length > 0 && (
              <>
                ...
                <div className="flex gap-2">
                  <button className="font-bold rounded font-4xl px-3 py-1 flex items-center justify-center bg-white transition-all duration-300 ease-in-out transform hover:bg-gray-200 hover:scale-105">
                    <img
